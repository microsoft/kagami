...
from function_check_handwriting import check_handwriting_blueprint
...
from function_store_results import store_results_blueprint

app = df.DFApp(http_auth_level=func.AuthLevel.ANONYMOUS)
app.register_functions(orchestrator_blueprint)
app.register_functions(chunk_file_blueprint)
app.register_functions(check_handwriting_blueprint)
...
app.register_functions(store_results_blueprint)
